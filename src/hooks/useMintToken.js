...
const useMintToken = () => {
    ...
    return useCallback(async () => {
        ...
        try {
            ...
            await contract.on("Minted", (to, tokenId) => {
                setNextTokenId(tokenId + 1);
                console.log("to: ", to, "tokenId: ", tokenId, "Next Token ID: ", nextTokenId);
                alert("to: ", to, "tokenId: ", tokenId, "Next Token ID: ", nextTokenId);
            });
